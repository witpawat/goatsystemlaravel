                    ...
                    <ul class="navbar-nav ">
                        ...
                        @else
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-1 btn ">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('goats.updateMultipleHome') }}" class="nav-link">อัปเดตข้อมูลเพิ่มเติม</a>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        ...
                                        href="{{ url('/edit-profile') }}">ตั้งค่าโปรไฟล์</a>

                                        <a href="#" class="dropdown-item">ตั้งค่าการเเจ้งเตือน</a>
